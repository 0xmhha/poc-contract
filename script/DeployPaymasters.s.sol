 ...
 *
 * Usage:
 *   forge script script/DeployPaymasters.s.sol:DeployPaymastersScript --rpc-url <RPC_URL> --broadcast
 */
contract DeployPaymastersScript is DeploymentHelper {
    ...
    function run() public {
        ...
        // 2. Deploy ERC20Paymaster (requires price oracle)
        ...
        // 3. Deploy Permit2Paymaster (requires permit2 and price oracle)
 ...
 *
 * Usage:
 *   ENTRYPOINT_ADDRESS=0x... VERIFYING_SIGNER=0x... forge script script/DeployPaymasters.s.sol:DeployVerifyingPaymasterScript --rpc-url <RPC_URL> --broadcast
 */
