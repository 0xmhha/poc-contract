...
/**
 * @title WKRW (Wrapped Native Token)
...
contract WKRW is ERC20 {
    ...
    /**
     * @notice Deposit native tokens and receive WKRW
     * @dev Mints WKRW 1:1 for deposited native tokens
     */
    ...
    /**
     * @notice Withdraw native tokens by burning WKRW
     * @param amount The amount of WKRW to burn
     */
     ...
     * @param to The address to receive WKRW
     */
