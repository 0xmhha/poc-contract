...
import { ValidationData, _parseValidationData, min, finalizeAllocation } from "./Helpers.sol";
...
contract EntryPoint is IEntryPointSimulations, StakeManager, NonceManager, ERC165, EIP712 {
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        unchecked {
            ...
            // This pattern rounds contextLength up to nearest 32-byte boundary,
            // division before multiplication is intentional (ceiling division).
