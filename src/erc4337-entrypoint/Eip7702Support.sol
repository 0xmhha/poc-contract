...
library Eip7702Support {
    ...
    function _getEip7702Delegate(address sender) internal view returns (address) {
        ...
        // casting to 'bytes3' is safe because we're extracting the first 3 bytes of the code prefix
        ...
        // casting to 'bytes20' is safe because we're extracting the delegate address from known EIP-7702 format
        // forge-lint: disable-next-line(unsafe-typecast)
